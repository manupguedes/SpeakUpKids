    ...
    <body>
        ...
        <main id="bodyLogin">
            ...
            <div class="container" style="top: 100px">
                <form action="responsavelRedefinirSenha.jsp" method="post" class="formCadastrar">
                    <button
                    ...
                    <div class="inputs">
                        ...
                        <input type="email" placeholder="Email" id="email" name="email_resp" required />
                        <br />
                        <label for="senha" class="fa-solid fa-lock"></label>
                        <input type="password" placeholder="Nova Senha" id="senha" name="senha_resp" required />
                        <br />
